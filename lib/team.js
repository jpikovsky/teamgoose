...
var team = [
	member('tcontois', 'Tim', 'Contois', 'senior', reader.readFileSync("tim_writeup.txt", 'utf8')),
	member('alassall', 'Alex', 'Lassalle', 'senior', reader.readFileSync("alex_writeup.txt", 'utf8')),
	member('agramign', 'Andrew', 'Gramigna', 'senior', reader.readFileSync("andrew_writeup.txt", 'utf8')),
	member('jpikovsk', 'Josh', 'Pikovsky', 'senior', reader.readFileSync("josh_writeup.txt", 'utf8')),
	member('rbcondon', 'Riley', 'Condon', 'senior', reader.readFileSync("riley_writeup.txt", 'utf8')),
	member('nmurali', 'Niketh', 'Murali', 'junior', reader.readFileSync("niketh_writeup.txt", 'utf8'))
];
