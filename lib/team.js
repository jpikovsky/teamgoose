...
var team = [
	member('tcontois', 'Tim', 'Contois', 'senior'),
	member('alassall', 'Alex', 'Lassalle', 'senior'),
	member('agramign', 'Andrew', 'Gramigna', 'senior'),
	member('jpikovsk', 'Josh', 'Pikovsky', 'senior'),
	member('rbcondon', 'Riley', 'Condon', 'senior'),
	member('nmurali', 'Niketh', 'Murali', 'junior')
];
...
function copy(memberToCopy) {
	// TODO
	return member(memberToCopy.user, memberToCopy.fname, memberToCopy.lname, memberToCopy.year);
}
